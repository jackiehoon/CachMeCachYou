...
public class bluetoothPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetoothpage);
        //인터넷 접속을 위한 문장
    ...
    final BroadcastReceiver blReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.v("hhd","found zzzz");
            if(BluetoothDevice.ACTION_FOUND.equals(action)){
                Log.v("hhd","found zzzz2222");
            ...
            new Thread()
            {
                public void run() {
                    ...
                    if(fail == false) {
                        ...
                        myBluetooth.startBluetooth(mBTSocket);
                        myApplication.setMyBluetooth(myBluetooth);
